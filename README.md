...
- **Multilingual support** — Agora ARES supports 36 languages; the system prompt explicitly instructs the agent to follow the witness's language/code-switching naturally
...
- Expansion of live-verified multilingual/code-switching coverage beyond the single pairing tested for this submission.
